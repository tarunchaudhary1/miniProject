...
// import JoinMcqScreen from "./components/Quiz/AttemptQuiz/Attempt Mcq/Join Screen/JoinMcqScreen";
// import JoinCompScreen from "./components/Quiz/AttemptQuiz/Attempt Comprehensive/Join Screen/JoinCompScreen"
...
export default function App() {
	...
	return (
		...
		{/* <Routes>
			...
			{admin && <Route path="/dashboard" exact element={<DashboardAdmin/>} />}
			{user && <Route path="/dashboard" exact element={<DashboardUser />} />}
			{admin && <Route path="/users/addnewuser" exact element={<AddNewUser />} />}
			{admin && <Route path="/users/userlist" exact element={<UserList />} />}
			{admin && <Route path="/admins/addnewadmin" exact element={<AddNewAdmin />} />}
			{admin && <Route path="/admins/adminlist" exact element={<Adminlist />} />}
			{admin && <Route path="/questions/addnewquestions" exact element={<AddNewQuestions />} />}
			{admin && <Route path="/questions/questionbank" exact element={<QuestionsBank  />} />}
			{user && <Route path="/questions/questionbank" exact element={<QuestionsBank  />} />}
			{admin && <Route path="/quiz/add_new_mcq_quiz" exact element={<AddNewMcqQuiz />} />}
			{admin && <Route path="/quiz/add_new_comp_quiz" exact element={<AddNewCompQuiz />} />}
			{admin && <Route path="/quiz/addnewquiz/addmcq/:id" exact element={<AddMcq />} />}
			{admin && <Route path="/quiz/addnewquiz/add_desc/:id" exact element={<AddDescriptive />} />}
			{admin && <Route path="/quiz/quizList" exact element={<QuizList />} />}
			{admin && <Route path="/quiz/mcq_quiz_list" exact element={<McqQuizList />} />}
			{admin && <Route path="/quiz/comp_quiz_list" exact element={<CompQuizList />} />}
			{admin && <Route path="/quiz/addnewquiz/add_mcq_user/:id" exact element={<AddMcqUser />} />}
			{admin && <Route path="/quiz/addnewquiz/add_comp_user/:id" exact element={<AddCompUser />} />}
			{admin && <Route path="/settings/groups" exact element={<Groups />} />}
			{admin && <Route path="/settings/categories" exact element={<Categories />} />}
			{admin && <Route path="/settings/GeneralSettings" exact element={<GeneralSettings />} />}
			{admin && <Route path="/result/:quizid" exact element={<MCQResult/>} />}
			{user && <Route path="/result/:id" exact element={<MCQResult />} />}
			{user && <Route path="/quiz/attempt_quiz" exact element={<AttemptQuiz />} />}
			{user && <Route path="/quiz/attempt_quiz/attempt_mcq/:id" exact element={<AttemptMcq />} />}
			{user && <Route path="/quiz/attempt_quiz/attempt_comp/:id" exact element={<AttemptComprehensive />} />}
			{admin && <Route path="/reset_password" exact element={<Mailer />} />}
			{admin && <Route path="/quiz/mcq_quiz_details/:id" exact element={<McqQuizDetails />} />}
			{admin && <Route path="/quiz/comp_quiz_details/:id" exact element={<CompQuizDetails />} />}
			{admin && <Route path="/all_results" exact element={<ResultChoose />} />}
			{admin && <Route path="/all_mcq_result" exact element={<AllMcqResultsList />} />}
			{admin && <Route path="/all_comp_result" exact element={<AllCompResultsList />} />}
			{admin && <Route path="/all_comp_result/evaluate_comp/:id" exact element={<EvaluateComp />} />}
			{user && <Route path="/mcq_result" exact element={<McqResult />} />}
			{user && <Route path="/comp_result" exact element={<CompResult />} />}
			{user && <Route path="/comp_result_list" exact element={<CompResultList />} />}
